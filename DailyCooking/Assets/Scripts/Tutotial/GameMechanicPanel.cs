...
{
    [SerializeField] private Window_QuestPointer pointer;

    private bool isTrackingCustomer = false;
    ...
    public void OnCustomerWalkIn()
    {
        pointer.Show(BotManager.Instance.ActiveBots[0].transform);
    }

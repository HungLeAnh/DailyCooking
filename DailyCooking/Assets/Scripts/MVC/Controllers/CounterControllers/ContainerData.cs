...
{
    public string KitchenObjectSOGuid { get; private set; }
    public float FillAmount { get; private set; } = 0f;

    public ContainerData(string kitchenObjectSOGuid, float fillAmount, string placedObjectTypeSOGuid, Vector2Int origin, Dir dir, InventoryTabType type)
